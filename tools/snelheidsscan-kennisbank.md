...
`struggle-voorbereiding`, `struggle-applicatie`, `struggle-frees`, `struggle-werkplek`, `struggle-afwerking`
...
Struggles uit checklist: affrezen oud product, nagelriemen reinigen, nagelriemen knippen, huid polijsten, nagelplaat opruwen, prep-primer-base, uitfrezen natuurlijke nagel.
...
Foto nodig: `conische-freesbit.jpg`
...
## Fase 4: Werkplek (tag: struggle-werkplek)
